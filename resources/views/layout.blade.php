...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                ...
                                <li><a href="#"><i class="fa fa-envelope"></i> Tiendo.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
    ...
    <footer id="footer"><!--Footer-->
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="companyinfo">
                            <h2><span>NTN</span>-Shopper</h2>
                            <p>Đảng Cộng sản Việt Nam quang vinh muôn năm!</p>
                        </div>
                    </div>
                    <div class="col-sm-7">
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{('public/frontend/images/ship_1.png')}}" alt="" />
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                         <img src="{{('public/frontend/images/ship_2.png')}}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="address">
                            ...
                            <p>Số 1 Đường Xuân Đỉnh, quận BTL, Hà Nội</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-sm-3 col-sm-offset-1">
                        <div class="single-widget">
                            ...
                            <form action="#" class="searchform">
                                ...
                                <p>Cập nhập thông tin chính thức và mới nhất <br />về sản phẩm mà bạn yêu thích...</p>
                            </form>
                        </div>
                    </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2021 NTN_Shop. All rights reserved.</p>
                    <p class="pull-right">Designed by <span><a target="_blank" href="https://www.facebook.com/ngocnt.5792">WEB DEVELOPER</a></span></p>
                </div>
            </div>
        </div>
