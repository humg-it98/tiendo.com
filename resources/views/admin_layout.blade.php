<!DOCTYPE html>
<head>
<link rel="shortcut icon" href="https://www.youtube.com/s/desktop/a57d6b77/img/favicon_48.png" sizes="48x48">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="{{('public/backend/images/02.png')}}">
                <span class="username">
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>Website đang trong quá trình phát triển. Nếu có bug vui long liên hệ : 0372105792 hoặc <a target="_blank" href="https://www.facebook.com/ngocnt.5792/">Facebook</a></p>
			</div>
		  </div>
  <!-- / footer -->
</section>
